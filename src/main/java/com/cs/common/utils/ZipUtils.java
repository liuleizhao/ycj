...
public class ZipUtils {
	...
	public static final String ZIPNAME = "file.zip";
	...
	public static void main(String[] args) {
		...
		// unZip("c://xutie//data.zip", "c://xutie");
		zip("c://xutie//", "c://xutie//data.zip");
		// unZip("c://xutie//data.zip", "c://xutie");
		// while (true) {
	...
	public static File[] filter(File[] files) {
		...
		for (File file : files) {
			if (file.getAbsolutePath().indexOf(".zip") == -1) {
				list.add(file);
			}
		}
